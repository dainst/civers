"""Configuration loader for CiVers Metadata Extractor.

This is the hierarchical configuration loader that supports:
...
class YamlFileConfigLoader:
    ...
    def load(self) -> ConfigDataModel:
        ...
        logger.debug(f"   Loaded {len(env_config)} top-level keys from environment")
