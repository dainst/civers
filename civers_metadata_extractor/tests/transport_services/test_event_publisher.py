...
class TestEventPublisher:
    ...
    def event_publisher(self, mock_connection_manager, sample_topics):
        ...
        return EventPublisher(connection_manager=mock_connection_manager, topics=sample_topics)
    ...
    def test_event_publisher_initialization(
        self, event_publisher, mock_connection_manager, sample_topics
    ):
    ...
    @pytest.mark.asyncio
    async def test_publish_extraction_completed_success(
        self, event_publisher, mock_connection_manager, sample_completion_event
    ):
    ...
    @pytest.mark.asyncio
    async def test_publish_extraction_failed_success(
        self, event_publisher, mock_connection_manager, sample_failure_event
    ):
    ...
    @pytest.mark.asyncio
    async def test_publish_workflow_progress_success(
        self, event_publisher, mock_connection_manager, sample_progress_event
    ):
    ...
    @pytest.mark.asyncio
    async def test_publish_event_with_kafka_error(
        self, event_publisher, mock_connection_manager, sample_completion_event
    ):
    ...
    @pytest.mark.asyncio
    async def test_publish_event_with_timeout(
        self, event_publisher, mock_connection_manager, sample_completion_event
    ):
    ...
    async def test_publish_event_core_functionality(self, event_publisher, mock_connection_manager):
        """Test core publish_event method directly."""
        test_data = {"test": "data", "key": "value"}

        # Execute
        result = await event_publisher.publish_event(
            topic="test.topic", key="test-key", event_data=test_data
        )
        ...
        mock_connection_manager.producer.send.assert_called_once_with(
            topic="test.topic", key="test-key", value=test_data
        )
