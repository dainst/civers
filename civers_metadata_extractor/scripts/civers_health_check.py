...
class SystemHealthCheck:
    ...
    def check_dependencies(self) -> bool:
        ...
        self.total_checks += 1
        required_packages = ["aiokafka", "pydantic", "yaml", "asyncio"]
    ...
    async def check_kafka_admin_connectivity(self) -> bool:
        ...
        try:
            ...
            logger.info("✅ Async Kafka admin client connectivity verified")
    ...
    async def check_kafka_producer_connectivity(self) -> bool:
        ...
        try:
            ...
            logger.info("✅ Async Kafka producer connectivity verified")
    ...
    async def check_kafka_consumer_connectivity(self) -> bool:
        ...
        try:
            ...
            logger.info("✅ Async Kafka consumer connectivity verified")
            if message_count > 0:
                logger.info(f"   - Consumed {message_count} test message(s) from {status_topic}")
            else:
                logger.info("   - Consumer ready (no messages to consume)")
