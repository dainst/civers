...
class KafkaConnectionManager:
    ...
    def __init__(self, kafka_config: KafkaConfig):
        ...
        self.producer: AIOKafkaProducer | None = None  # Created via setup_producer()
        self.consumer: AIOKafkaConsumer | None = None  # Created via setup_consumer() with topics
    ...
    async def setup_producer(self) -> AIOKafkaProducer:
        ...
        try:
            ...
            raise KafkaError(f"Producer setup failed: {e}") from e
    ...
    async def setup_consumer(self, topics: list[str]) -> AIOKafkaConsumer:
        ...
        try:
            ...
            raise KafkaError(f"Consumer setup failed: {e}") from e
