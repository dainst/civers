...
class TransformationEngine:
    ...
    def _apply_rule(
        self, input_key: str, input_value: Any, rule: MappingRule, target_structure: dict[str, Any]
    ):
        """
    ...
    def _resolve_target_indices(
        self, target_segments: list[PathSegment], input_indices: list[int | None]
    ) -> list[PathSegment]:
        """
        ...
        for seg in target_segments:
            ...
            is_wildcard = seg.index == "*" or (
                isinstance(seg.index, str) and not seg.index.isdigit()
            )
    ...
    def _apply_static_values(
        ...
        resolved_path: list[PathSegment],
