...
from configs.models import AppConfig, ConfigDataModel
...
class TestMetadataExtractionAppInitialization:
    ...
    async def test_initialize_success(self):
        ...
        with (
            patch("main.MetadataExtractionService") as mock_metadata_service,
...
class TestMetadataExtractionAppStartup:
    ...
    async def test_start_handles_transport_error_gracefully(self):
        ...
        with (
            patch("main.MetadataExtractionService"),
            patch("main.KafkaTransportService") as mock_kafka_service,
        ):
            mock_kafka_instance = AsyncMock()
            ...
            try:
                ...
                async def trigger_shutdown():
                    ...
                    assert current_sigint != original_sigint, (
                        "SIGINT handler should be registered after start()"
                    )
...
class TestErrorScenarios:
    ...
    async def test_metadata_service_check_failure(self):
        ...
        with (
            patch("main.MetadataExtractionService") as mock_service,
