...
def array_mapping_sample_data():
    ...
    return {
        ...
        "author": [
            {
                "name": "Dr. Jane Smith",
                "affiliation": [{"name": "University A"}, {"name": "Institute B"}],
            },
            {"name": "Prof. John Doe", "affiliation": [{"name": "University C"}]},
        ],
        "publisher": [
            {"name": "Academic Press", "identifier": {"value": "pub-123"}},
            {"name": "Research Institute", "identifier": {"value": "pub-456"}},
        ],
        "keywords": ["archaeology", "roman", "pottery", "excavation"],
        "spatialCoverage": [
            {"name": "Rome, Italy", "geo": {"latitude": "41.9028", "longitude": "12.4964"}},
            {"name": "Florence, Italy", "geo": {"latitude": "43.7696", "longitude": "11.2558"}},
        ],
        "temporalCoverage": [{"name": "Roman Period"}, {"name": "Imperial Period"}],
        "citation": [
            {"name": "Reference A", "identifier": {"value": "ref-001"}},
            {"name": "Reference B", "identifier": {"value": "ref-002"}},
        ],
        "image": [
        ...
        "contributor": [
            {
                "name": "Contributor A",
                "identifier": [{"value": "orcid-001"}, {"value": "researcher-id-001"}],
            }
        ],
    }
        ...
        "author": [
            {
                ...
                "sameAs": ["https://www.wikidata.org/wiki/Q695302"],
            },
            {
                "@type": "Organization",
                "identifier": {
                ...
                "sameAs": ["https://www.wikidata.org/wiki/Q54096"],
            },
        ],
        "publisher": [
            {
        ...
        "spatialCoverage": [
            {
                ...
                "geo": {"@type": "GeoCoordinates", "latitude": "41.90225", "longitude": "12.4533"},
            }
        ],
        "temporalCoverage": [
            {
