"""
Centralized logging configuration for the Metadata Extractor system.
...
def setup_logging(
    level: int = logging.INFO, log_file: str | None = None, suppress_kafka_logs: bool = True
) -> None:
    """
    Configure logging for the Metadata Extractor system.
