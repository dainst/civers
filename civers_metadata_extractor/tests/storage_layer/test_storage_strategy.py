...
from storage_layer.storage_strategy import (
    StorageResult,
    MultiStorageResult,
    StorageStrategy
)
...
class TestStorageResult:
    ...
    def test_create_successful_result(self):
        ...
        result = StorageResult(
            ...
            storage_location="/path/to/file.json"
        )
...
class TestMultiStorageResult:
    ...
    def test_create_multi_result_all_failed(self):
        ...
        results = [
            ...
            StorageResult(success=False, storage_type="civers_rest_api", error_message="Network error")
        ]
