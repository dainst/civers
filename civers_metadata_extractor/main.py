...
class MetadataExtractionApp:
    ...
    def __init__(self, config_loader: YamlFileConfigLoader | None = None):
        self.config = None
        self.config_loader = config_loader
        self.kafka_transport: KafkaTransportService | None = None
        self.running = False
    ...
    async def initialize(self):
        ...
        try:
            ...
            logger.info(
                f"   Bootstrap servers: {self.config.app.get_kafka_config().bootstrap_servers}"
            )
    ...
    async def start(self):
        ...
        try:
            ...
            _, pending = await asyncio.wait(
                [transport_task, shutdown_task], return_when=asyncio.FIRST_COMPLETED
            )
...
async def main_async(app: MetadataExtractionApp | None = None):
