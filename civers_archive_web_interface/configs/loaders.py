"""
Configuration loader for separate component consistency.
...
It follows the standard CiVers configuration pattern.
"""
...
class YamlFileConfigLoader:
    ...
    def _load_environment_overrides(self) -> Dict[str, Any]:
        ...
        Raises:
            ConfigurationError: If environment file doesn't exist and environment was explicitly set
        """
